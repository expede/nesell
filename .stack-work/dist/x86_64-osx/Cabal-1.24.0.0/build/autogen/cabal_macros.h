...
/* package nestle-0.1.0.0 */
#define VERSION_nestle "0.1.0.0"
#define MIN_VERSION_nestle(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "nestle-0.1.0.0-5aEU267mA5X7smbTQ9GxtM"

#define CURRENT_PACKAGE_KEY "nestle-0.1.0.0-5aEU267mA5X7smbTQ9GxtM"
